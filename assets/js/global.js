...
function decodeBase64 (input) {
    var Base64={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
        encode:function(e){
            var t="";
            var n,r,i,s,o,u,a;var f=0;e=Base64._utf8_encode(e);
            while(f<e.length){
                n=e.charCodeAt(f++);
                r=e.charCodeAt(f++);
                i=e.charCodeAt(f++);
...
function init_validate_forms (form_id, rules = {} , message = {}, extra_form = [], submit_form = true) {
    $(form_id).validate({
        errorClass: 'invalid',
        errorElement: 'em',
        ignore: [],
...
function init_datatables (table_id, ajax_source = "", columns = "", extra_params = [".filter-this"], sorting = false , display_length = 50) {
    ...
    $(table_id + " input[type=text].filter-this").bind( 'change keyup input', function () {
