...
(function( $ ){
  $.fn.printPage = function(options, firepower) {
    ...
    /**
     * directly show the print page.
     */
    if (firepower) {
        loadPrintDocument(this, pluginOptions);
    };

    //matiin karena ga boleh lagi tuh ada listener ini.
    ...
    function addIframeToPage(el, pluginOptions){
        ...
        if(!$('#printPage')[0]){
          ...
          $('#printPage').ready(function() {
              //print it after the iframer is fully loaded.
    ...
    function printit(){
        ...
        //untuk mengsuport firefox print. karena firefox nya tidak bisa mencetak using iframe.
        var iframe = document.getElementById("printPage");
        iframe.onload = function() {
            iframe.focus(); iframe.contentWindow.print();
        };
