    ...
    <div class="main-content-agile">
        <div class="sub-main-w3">   
            ...
            <form action="<?php echo site_url('login');?>" method="POST" id="login-form">
                ...
                <div class="sub-w3l">
                    <!-- <h6><a href="<?php //site_url('forgot-password'); ?>" target="_blank">Forgot Password?</a></h6> -->
                    <div class="right-w3l">
            ...
            <div class="col-lg-12" style="color:white;">
                <p>&copy; <?php echo date('Y') ?> Development AKS. All rights reserved || Design by <a href="">IT DEVELOPMENT AKS</a></p>
            </div>
        </div>
    </div>
    <!--//main-->