...
class Admin_model extends CI_Model {
    ...
    public function check_login($nik, $password) {
        ...
        //check password.
        if ($user['user_password'] == sha1( ENCRYPT_DEV_AKS . $this->db->escape_str($password)) ) {
            return $user;
        }
    ...
    /**
     * check username and password (for print data).
     */
    public function check_password( $username, $pass )
    {
        ...
        //check password.
        if ($user['user_password'] == sha1( ENCRYPT_DEV_AKS . $this->db->escape_str($pass)) ) {
            return $user;
        }
        return false;
    }
