    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 col-lg-offset-1 text-right">
            <h1>
                ...
                ?>
                <a class="btn btn-warning back-button" href="<?= site_url('user/'.$url) ?>" title="Back" rel="tooltip" data-placement="left" data-original-title="Batal">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <?php 
                                        ...
                                        <section class="col col-6" id="username">
                                    ...
                                    <?php if($user_id == 0 || $level == "SYSTEM" || $level == "ADMINISTRATOR"): ?>
                                    <section class="col col-6">
