<script>
    ...
    var ajax_source = "<?= site_url('user/list_all_data_hsbc'); ?>";
    ...
    var columns = [
        ...
        },
        {
            ...
            "render": function(data, type, full) {
                var edit =  '<td>';
                    // edit +=  ' <a href="' + url +'/user/view/' + full.user_id + '" class="btn btn-info btn-circle" rel="tooltip" title="View User" data-placement="top" ><i class="fa fa-eye"></i></a>';
