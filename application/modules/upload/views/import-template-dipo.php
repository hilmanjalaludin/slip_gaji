...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 text-right">
            <h1>
                <a class="btn btn-primary btn-s" href="<?php echo base_url(); ?>assets/template-import/TEMPLATE_UPLOAD_DIPO.xlsx">
                    Download Template &nbsp;&nbsp;
                ...
                <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-001" data-widget-editbutton="false" data-widget-deletebutton="false">
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <form class="smart-form" id="hsbc-form" action="<?php echo site_url('upload/process_import_dipo'); ?>" method="POST">
                                <fieldset>
                                    <div class="row">
