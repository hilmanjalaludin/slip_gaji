        ...
        <div class="page-footer">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <span class="txt-color-white">SISG <a href="<?= site_url('change_log'); ?>" target="_blank" class="txt-color-white">V <?= $log['log_curr_version']; ?> </a> <span class="hidden-xs"></span> © 2018 - <?= date('Y'); ?></span>
                </div>
            </div>
        </div>
		...
		<!-- MAIN APP JS FILE -->
		<script src="<?= base_url(); ?>assets/js/app.js?ver=<?= VERSION_JS_APP ?>?<?= time(); ?>"></script>
		<script src="<?= base_url(); ?>assets/js/global.js?ver=<?= VERSION_JS ?>?<?= time(); ?>"></script>
        <?php
