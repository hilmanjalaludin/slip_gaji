					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						...
						<span>
							<?php 
								...
								$full = $this->session->userdata('full_name');
							?>
							<?= ($name != "") ? $name : $full; ?> 
						</span>
			...
			<nav>
				...
				<ul>
                        	...
                        	<?php 
								...
								if( $level == "STAFF INTERNAL" ) : ?>
									...
									<li class="<?= (isset($active_page) && $active_page == "slip-hsbc-list") ? "active" : "" ?>">
										<a href="<?= site_url("slip/list") ?>" title="SLIP HSBC"><span class="menu-item-parent">View Slip</span></a>
									</li>
									<?php elseif( $level == "AGENT BNI") : ?>
									<li class="<?= (isset($active_page) && $active_page == "slip-bni-list") ? "active" : "" ?>">
										<a href="<?= site_url("slip/list_bni") ?>" title="SLIP BNI"><span class="menu-item-parent">View Slip</span></a>
									</li>
									<?php elseif($level == "AGENT DIPO") :?>
									<li class="<?= (isset($active_page) && $active_page == "slip-dipo-list") ? "active" : "" ?>">
										<a href="<?= site_url("slip/list_dipo") ?>" title="SLIP DIPO"><span class="menu-item-parent">View Slip</span></a>
									</li>
									<?php elseif($level == "AGENT CHAR") :?>
									<li class="<?= (isset($active_page) && $active_page == "slip-char-list") ? "active" : "" ?>">
										<a href="<?= site_url("slip/list_char") ?>" title="SLIP CHAR"><span class="menu-item-parent">View Slip</span></a>
									</li>
									<?php else :?>
									<li class="<?= (isset($active_page) && $active_page == "slip-list") ? "active" : "" ?>">
									...
									<li class="<?= (isset($active_page) && $active_page == "slip-char-list") ? "active" : "" ?>">
										<a href="<?= site_url("slip/list_char") ?>" title="SLIP CHAR"><span class="menu-item-parent">View Slip CAR</span></a>
									</li>
						<?php endif; ?>
						</ul>
					</li>
                    ...
                    <?php 
						...
						<li class="">
	                        ...
	                        <ul>
								...
								<li class="<?= (isset($active_page) && $active_page == "import-char") ? "active" : ""?>">
									<a href="<?= site_url('upload/import_char'); ?>" title="Upload Data"><span class="menu-item-parent">Upload slip agent CAR</span></a>
								</li>
						...
						<li class="">
	                        ...
	                        <ul>
								<li class="<?= (isset($active_page) && $active_page == "import-user") ? "active" : ""?>">
									<a href="<?= site_url('upload/import-user'); ?>" title="Upload Data User"><span class="menu-item-parent">Upload data user</span></a>
								</li>
						...
						<li class="">
	                        ...
	                        <ul>
								<li class="<?= (isset($active_page) && $active_page == "user-list") ? "active" : ""?>">
									<a href="<?= site_url('user'); ?>" title="User Administrator"><span class="menu-item-parent">User Administrator</span></a>
								</li>

								<li class="<?= (isset($active_page) && $active_page == "user-list-hsbc") ? "active" : ""?>">
									<a href="<?= site_url('user/list-hsbc'); ?>" title="List Data User"><span class="menu-item-parent">List Data User HSBC</span></a>
								</li>

								<li class="<?= (isset($active_page) && $active_page == "user-list-bni") ? "active" : ""?>">
									<a href="<?= site_url('user/list-bni'); ?>" title="List Data User BNI "><span class="menu-item-parent">List Data User BNI</span></a>
								</li>

								<li class="<?= (isset($active_page) && $active_page == "user-list-dipo") ? "active" : ""?>">
									<a href="<?= site_url('user/list-dipo'); ?>" title="List Data User DIPO"><span class="menu-item-parent">List Data User DIPO</span></a>
								</li>

								<li class="<?= (isset($active_page) && $active_page == "user-list-char") ? "active" : ""?>">
									<a href="<?= site_url('user/list-char'); ?>" title="List Data User CAR"><span class="menu-item-parent">List Data User CAR</span></a>
								</li>

								<li class="<?= (isset($active_page) && $active_page == "create-user") ? "active" : ""?>">
									<a href="<?= site_url('user/create'); ?>" title="Create User"><span class="menu-item-parent">Create User</span></a>
								</li>
							</ul>
						</li>
					<?php } ?>
					<?php 
	                    ...
	                    if( $level == "SYSTEM") { ?>
	                    	<li class="<?= (isset($active_page) && $active_page == "create-user") ? "active" : ""?>">
								<a href="<?= site_url('change_log/create'); ?>" title="Create User"><i class="fa fa-lg fa-fw fa-server"></i> 
									<span class="menu-item-parent">Update Change Log</span>
								</a>
							</li>
                    <?php }?>
				</ul>
