<script type="text/javascript">
	...
	*/
	...
	var lists = function () {
	    ...
	    var ajax_source = "<?= site_url('slip/list_all_data_dipo') ?>";
	            ...
	            "render": function(data, type, full) {
	                var edit =  '<td>';
	                    ...
	                    if( role_session == "ADMINISTRATOR" || role_session == "SYSTEM") {
							edit += '<a href="'+ url +'delete_dipo" data-id ="' + full.upload_id + '" data-name ="' + full.name + '" class="btn btn-danger btn-circle delete-confirm" rel="tooltip" title="Delete Slip" data-placement="top" ><i class="fa fa-trash-o"></i></a>';
						}                             
	                    edit +=  '</td>';
	            ...
	            showPasswordConfirm(function(pass) {
	                ...
	                $.ajax({
	                    ...
	                    success: function(data) {
	                        ...
	                        $('.loading').css("display", "none");
	                        console.log(data);
	                        window.open("<?= site_url('slip/detail-print-dipo/'); ?>"+ should_validate);
	                       // location.href = 
	                    },
	                    error: function() {
	                        console.log("error");
