...
<body onload="onbeforeunload()">
    <div class="page">
        ...
        <?php 
            ...
            $allowance          = ($data_print['tunjangan_jabatan']) ? round($data_print['tunjangan_jabatan']) : "0"; 
            ...
            //PEMOTONGAN
            $bpjs_kesehatan     = ($data_print['bpjs_kesehatan_2']) ? round($data_print['bpjs_kesehatan_2']) : "0";
            $bpjs_pensiun       = ($data_print['bpjs_pensiun_2']) ? round($data_print['bpjs_pensiun_2']) : "0";
            $bpjs_tenaga_kerja  = ($data_print['bpjs_tenaga_kerja_2']) ? round($data_print['bpjs_tenaga_kerja_2']) : "0";
            $pph21              = ($data_print['pph_pasal_21']) ? round($data_print['pph_pasal_21']) : "0";
            $potongan_parkir    = ($data_print['potongan_parkir']) ? round($data_print['potongan_parkir']) : "0";
            $potongan_outing    = ($data_print['potongan_outing']) ? round($data_print['potongan_outing']) : "0";
        ...
        <div style="position: fixed;margin-top: 50mm; margin-left: 4mm;width: 200mm;">
            ...
            <table width="100%" class="table">
                <tr>
                    ...
                    <td></td>
                    <td>BPJS Kesehatan <span style="margin-left: 13.7mm;"></span>: <?= number_format($bpjs_kesehatan); ?></td>
                </tr>
                <tr>
                    <td colspan="1">Allowance<span style="margin-left: 21mm;"></span>:&nbsp;&nbsp;<?= number_format($allowance) ?></td>
                    <td></td>
                    <td>BPJS Pensiun <span style="margin-left: 19mm;"></span>: <?= number_format($bpjs_pensiun); ?></td>
                </tr>
                <tr>
                    <td colspan="1">Over Time<span style="margin-left: 22.2mm;"></span>:&nbsp;&nbsp;<?= $ot ?></td>
                    <td></td>
                    <td>BPJS Ketenagakerjaan <span style="margin-left: 0.5mm;"></span>: <?= number_format($bpjs_tenaga_kerja); ?></td>
                </tr>
                <tr>
                    <td colspan="1">Transport <span style="margin-left: 19.2mm;"></span>:&nbsp;&nbsp;<?= $transport; ?></td>
                    <td></td>
                    <td>PPH Pasal 21 <span style="margin-left: 19.6mm;"></span>: <?= number_format($pph21); ?></td>
                </tr>
                <tr>
                    <td colspan="1">Komisi <span style="margin-left: 27.5mm;"></span>:&nbsp;&nbsp;<?= $komisi; ?></td>
                    <td></td>
                    <td>Potongan Parkir <span style="margin-left: 12.5mm;"></span>: <?= number_format($potongan_parkir); ?></td>
                </tr>
                <tr>
                    <td colspan="1">Rapelan Gaji<span style="margin-left: 15.4mm;"></span>:&nbsp;&nbsp;<?= round($gaji_repelan); ?></td>
                    <td></td>
                    <td>Potongan Outing <span style="margin-left: 12.5mm;"></span>: <?= number_format($potongan_outing); ?></td>
                </tr>
                <tr>
