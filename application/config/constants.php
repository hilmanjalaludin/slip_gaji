...
|
*/
define("VERSION_JS", "1.6");
define("VERSION_JS_APP", "1.5");
define("ENCRYPT_DEV_AKS", 'AKSDEVencryptDidiGantengS');
//-- DEFAULT PAGER AND LIMIT
define("PAGER_PAGE_LIMIT", 20);
define("LIMIT_SEARCH", 20);
define('DEFAULT_LINK_VALUE', 'javascript:void(0);');
define("DEFAULT_TITLE_MANAGER", "Menagement System SMS Broadcast");
...
//-- EMAIL
define("DEFAULT_EMAIL_FROM", "devel@it-underground.web.id");
define("DEFAULT_EMAIL_FROM_NAME", "Info aseanindo");
define("DEFAULT_EMAIL_RETURN_PATH", "devel@it-underground.web.id");
...
//-- Manager breadcrumbs
define("MANAGER_HOME", '/devel_aks');
define("MANAGER_HEADER", 'layout/headers/header');
define("MANAGER_FOOTER", 'layout/footers/footer');
define("MANAGER_HEADER_SIGNIN", 'layout/headers/header_signin');
define("MANAGER_FOOTER_SIGNIN", 'layout/footers/footer_signin');

define("API_KEY_GOOGLE_JS", 'AIzaSyDLPhhxzjGhof2mSVNxumwwsDgd-W-9sjc');
define("DECRYPT_DEV_AKS", "didiganteng");
